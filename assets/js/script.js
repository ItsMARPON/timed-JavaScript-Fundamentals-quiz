...
function resetQuiz () {
  ...
  li1.removeAttribute("style", "font-size: 25px; font-weight: bold; text-decoration: underline;");
  li2.removeAttribute("style", "font-size: 25px; font-weight: bold; text-decoration: underline;");
  li3.removeAttribute("style", "font-size: 25px; font-weight: bold; text-decoration: underline;");
  li4.removeAttribute("style", "font-size: 25px; font-weight: bold; text-decoration: underline;");
...
function resetQuiz () {
  ...
  questionsQuiz.classList.add('hide');
  questionsQuiz.remove(questionOne);
  questionsQuiz.remove(questionTwo);
  timerTiktok.classList.add('hide');
  multipleChoice.classList.add('hide');
  li1.removeAttribute("style", "font-size: 25px; font-weight: bold; text-decoration: underline;");
  li2.removeAttribute("style", "font-size: 25px; font-weight: bold; text-decoration: underline;");
...
function resetQuiz () {
  ...
  questionsQuiz.remove(questionOne);
  questionsQuiz.remove(questionTwo);
  questionsQuiz.remove(questionThree);
  questionsQuiz.remove(questionFour);
  timerTiktok.classList.add('hide');
  multipleChoice.classList.add('hide');
  li1.removeAttribute("style", "font-size: 25px; font-weight: bold; text-decoration: underline;");
  li2.removeAttribute("style", "font-size: 25px; font-weight: bold; text-decoration: underline;");
...
function nextQuestion5 () {
    ...
    submitButton.classList.remove('hide');
    multipleChoice.classList.remove('hide');
    questionsQuiz.append(questionFive);
